...
class WC_STBN_Integration extends WC_Integration {
    ...
    public function init_form_fields()
    {
        ...
        $this->form_fields['wc_stbn_shipping_carrier'] = array(
            ...
            'type'          => 'select',
            'description'   => __( 'Currently this plugin supports one shipping provider, unless overridden by the hook <kbd>woocommerce_stbn_shipping_carrier</kbd>.', 'wc-stbn-plugin' ),
        ...
        $this->form_fields['wc_stbn_order_status'] = array(
                ...
                'type'          => 'select',
                'description'   => __( 'Typically this feature is used to set an order to <b>Complete</b> after shipment.', 'wc-stbn-plugin' ),
